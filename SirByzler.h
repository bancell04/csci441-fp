...
public:
    ...
    SirByzler( GLuint shaderProgramHandle, GLint mvpMtxUniformLocation, GLint normalMtxUniformLocation, GLint materialColorUniformLocation );
...
private:
    ...
    /// \desc color of the plan's wheel
    ...
    /// \param viewMtx camera view matrix to apply to plane
    /// \param projMtx camera projection matrix to apply to plane
    void _drawWheel(bool isFrontWheel, bool isLeftWheel, glm::mat4 modelMtx, glm::mat4 viewMtx, glm::mat4 projMtx ) const;
    ...
    /// \param viewMtx camera view matrix to apply to plane
    /// \param projMtx camera projection matrix to apply to plane
    void _drawPlanePropeller(bool isFront, glm::mat4 modelMtx, glm::mat4 viewMtx, glm::mat4 projMtx ) const;
