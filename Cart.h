...
public:
    ...
    Cart(glm::vec3 location, glm::vec3 direction, GLfloat radius );
    ...
    void draw(::CSCI441::ShaderProgram* shaderProgram, int mvpUniformLocation, int colorUniformLocation, glm::mat4 modelMtx, glm::
    mat4 projViewMtx, CSCI441::ModelLoader* _pCartModel);
