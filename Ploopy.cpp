...
Ploopy::Ploopy( GLuint shaderProgramHandle, GLint mvpMtxUniformLocation, GLint normalMtxUniformLocation, GLint materialColorUniformLocation ) {
    _propAngle = 0.0f;
    ...
    _scaleProp = glm::vec3( 10.1f, 1.0f, 0.025f );
...
void Ploopy::drawPlane( glm::mat4 modelMtx, glm::mat4 viewMtx, glm::mat4 projMtx ) {
    ...
    modelMtx = glm::rotate( modelMtx, _rotatePlaneAngle+3.14f, CSCI441::Y_AXIS );
    // modelMtx = glm::translate( modelMtx,glm::vec3( 0.1f, 0.0f, 0.0f ));
...
void Ploopy::flyForward() {
    _propAngle += _propAngleRotationSpeed;
    if( _propAngle > _2PI ) _propAngle -= _2PI;
}

void Ploopy::flyBackward() {
    _propAngle -= _propAngleRotationSpeed;
    if( _propAngle < 0.0f ) _propAngle += _2PI;
}

void Ploopy::_drawPlaneBody(glm::mat4 modelMtx, glm::mat4 viewMtx, glm::mat4 projMtx ) const {
    modelMtx = glm::scale( modelMtx, _scaleBody );
    modelMtx = glm::rotate( modelMtx, _rotateBody, CSCI441::X_AXIS);
...
void Ploopy::_drawPlaneWing(bool isLeftWing, glm::mat4 modelMtx, glm::mat4 viewMtx, glm::mat4 projMtx ) const {
...
void Ploopy::_drawPlaneNose(glm::mat4 modelMtx, glm::mat4 viewMtx, glm::mat4 projMtx ) const {
...
void Ploopy::_drawPlanePropeller(glm::mat4 modelMtx, glm::mat4 viewMtx, glm::mat4 projMtx ) const {
    glm::mat4 modelMtx1 = modelMtx;
...
void Ploopy::_drawPlaneTail(glm::mat4 modelMtx, glm::mat4 viewMtx, glm::mat4 projMtx ) const {
    _computeAndSendMatrixUniforms(modelMtx, viewMtx, projMtx);
...
void Ploopy::_computeAndSendMatrixUniforms(glm::mat4 modelMtx, glm::mat4 viewMtx, glm::mat4 projMtx) const {
